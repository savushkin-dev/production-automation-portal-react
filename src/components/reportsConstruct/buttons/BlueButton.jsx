...
export function BlueButton({
    ...
    return (
        <button
            ...
            disabled={disabled}
            title={title}
            className={`px-3 text-[0.900rem] font-medium rounded-md bg-blue-800 hover:bg-blue-700 text-white transition-all duration-200 shadow-sm hover:shadow-md active:scale-[0.98]
