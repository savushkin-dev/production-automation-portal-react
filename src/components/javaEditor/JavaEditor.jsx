                            ...
                            <div className="flex items-center gap-4 ">
                                ...
                                <div>
                                    <p className="text-sm text-gray-600 leading-relaxed">
                                        ...
                                        Эти параметры будут доступны для заполнения пользователю, просматривающему отчет.
                                        Порядок параметров можно изменить, удерживая кнопку ⋮⋮ и перетаскивая в нужное место.
                                    </p>
                                </div>
                            </div>
